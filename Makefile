...
CCC = g++
CXX = g++
BASICOPTS = -g -std=c++11 -Wno-deprecated-declarations -I/usr/local/include -L/usr/local/lib64 -lboost_system -lboost_filesystem -pthread -lboost_thread -lavdevice -lavdevice -lavutil -lavformat -lavcodec -lcurl -lsodium -static-libstdc++
CCFLAGS = $(BASICOPTS)
CXXFLAGS = $(BASICOPTS)
CCADMIN =
